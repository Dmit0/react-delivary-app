...
export const add_restaurant_to_loved = (restaurant: restaurantType): lovedActionTypes => {
  return {
    type: RESTAURANT_ADD_TO_LOVED,
    add_loved_restaurant: restaurant,
  };
};
export const remove_restaurant_from_loved = (restaurant: restaurantType): lovedActionTypes => {
  return {
    type: RESTAURANT_REMOVE_FROM_LOVED,
    remove_loved_restaurant: restaurant,
  };
};
export const set_loved_restaurant_from_localeStorage = (restaurants: restaurantType[]): lovedActionTypes => {
  return {

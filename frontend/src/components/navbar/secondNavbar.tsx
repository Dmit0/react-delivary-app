          ...
          <div className="App_header__secondary">
              <nav className="navbar">
                <div className="container-fluid  App_header__secondary-container">
                  ...
                  />
                  <div>
                    <input className="form-control  App_header__secondary-input" value={value} type="search" placeholder="Search"  aria-label="Search" onChange={(event:React.ChangeEvent<HTMLInputElement>)=>onFilterTextChange(event.target.value)}/> 

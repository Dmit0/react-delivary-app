    ...
    return(
        <div className="App_header__secondary-action">
             ...
             <div className="dropdown navbar-brand-menu-switcher">
                    <button  className={ currentCuisen ==='' ?`btn btn-secondary dropdown-toggle navbar-brand-menu-switcher-button` : `btn btn-secondary dropdown-toggle active-button` }  type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false">

...
export const LoginPopup:React.FC<LoginProps>=({registrationHeandler})=>{
    return(
            <div className='main-auth-popup'>
                ...
                <div className="auth-futer">
                  <div className="auth-next-step">
                    <button type="button" className="btn btn-outline-primary auth-next-step-button ">Next</button>
                  </div>
                  <div className="auth-redirect-to-Registration">
                      Dont`t have an account?
                      <span onClick={registrationHeandler}>Sign Up</span>
                  </div>
                </div>
            </div>
    )

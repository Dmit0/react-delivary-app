...
interface CartProps{
    meal:meals
    onDelteOneItem(meal:meals):void
    onDelteMeal(meal:meals):void
    onAddMeal(meal:meals):void
}

export const Cart_item:React.FC<CartProps>=({meal,onDelteOneItem,onDelteMeal,onAddMeal})=>{
    ...
    return (
        ...
        <div className='cart-item'>
            ...
            <div className='item-button-controller'>
                ...
                <span className='minusButton' onClick={()=>{onDelteOneItem(meal)}}>
                    <svg width="1.7em" height="1.5em" viewBox="0 0 16 16" className="bi bi-dash-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
            ...
            <span className='delete-button' onClick={()=>onDelteMeal(meal)}>

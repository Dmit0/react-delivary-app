...
export type restaurantActionTypes = SET_CURRENT_RESTAURANT | SET_REASTAURANTS | SET_MEALS | SET_CUISENS | SET_FILTER_RESTAURANTS | SET_INPUT_FILTER | DELETE_CURRENT_RESTAURANT_AND_MEALS

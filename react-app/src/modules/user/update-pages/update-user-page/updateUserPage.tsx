...
const UpdateUserPage: React.FC = () => {
  ...
  const onSubmit = useCallback(async(data: any) => {
    const updateData = Object.keys(data).reduce((acc, item) => {
      if (data[item]) return {...acc, [item]: data[item]}
      return acc
    },{})
                    ...
                    <div className="update_user_form_fields">
                      ...
                      <div className="update_user_form_field">
                        <div className="update_user_form_labels">
                          <span>email</span>
                          { f.errors.email && f.errors.email.type === 'pattern' && isEmailValidated && <span className="update_user_form_error">it isnt`t email</span> }
                          { isEmailValidated && f.watch('email') !== '' && !f.errors.email && <span className="update_user_form_error">email exist</span>}
                        </div>
                        <input
                      ...
                      <div className="update_user_form_field">
                        ...
                        <div className="update_user_form_password">
                          ...
                          />
                          {(isPasswordChanged && comparePassword) &&
                          <span className="update_user_form_password_ok">
                            <CheckIcon/>
                          </span>}
                          {(isPasswordChanged && !comparePassword) &&
                          <span className="update_user_form_cancel">
                            <XIcon/>
                          </span>}
                        </div>
                      </div>
